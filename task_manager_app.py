...
<style>
    ...
    .task-list {
        padding: 0.5rem;
        background-color: rgba(59, 66, 83, 0.3);
    ...
    /* Default Category Badge (if no specific one matches) */
    ...
    .badge-category-calls {
        background-color: #17a2b8; /* Teal */
        color: white;
    }
    .badge-category-meetings {
        background-color: #6610f2; /* Indigo */
        color: white;
    }
    .badge-category-emails {
    ...
    /* Effort Badges */
    .badge-effort-default { /* For unparsed or out-of-range efforts */
        background-color: #607D8B; /* Original Blue Grey */
        color: white;
    }
    .badge-effort-low {
    ...
    .warning-flash {
        animation: warning-pulse 1.5s ease-out;
    }
    ...
    .error-flash {
        animation: error-pulse 1.5s ease-out;
    }
    ...
    .app-header {
        ...
        margin-bottom: 2rem;
        padding: 1rem;
        background: linear-gradient(90deg, #3b4253 0%, #2b3151 100%);
        border-radius: 8px;
